...
func (c *collector) addAndRecurse(owner *moduleAdapter, disable bool) error {
  moduleConfig := owner.Config()

  for _, moduleImport := range moduleConfig.Imports {
    disabled := disable || moduleImport.Disable
...
// TODO(bep) add a warning when the above happends.
