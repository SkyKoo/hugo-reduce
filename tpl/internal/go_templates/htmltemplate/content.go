...
const (
  ...
  // embedded content and newwork messages are formed, vetted,
...
func stringify(args ...any) (string, contentType) {
  ...
  for _, arg := range args {
    ...
    args[i] = indirectToStringOrError(arg)
    i++
  }
  return fmt.Sprint(args[:i]...), contentTypePlain
}

// indirect returns the value, after dererferencing as many times
...
// indirectToStringOrError returns the value, after dereferencing as many times
// as necessary to reach the base type (or nil) or an implementation of fmt.Stringer
// or error,
func indirectToStringOrError(a any) any {
  if a == nil {
    return nil
  }
  v := reflect.ValueOf(a)
